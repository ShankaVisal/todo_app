        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: Colors.white.withValues(
                alpha: 0.13, red: 1.0, green: 1.0, blue: 1.0),
            borderRadius: BorderRadius.circular(18),
            border: Border.all(color: Colors.white.withValues(alpha: 0.2, red: 1, green: 1, blue: 1), width: 1.2),
          ),
          child: TextField(
        ...
        child: ElevatedButton(
          style: ElevatedButton.styleFrom(
            backgroundColor: Colors.white.withValues(
                alpha: 0.2, red: 1.0, green: 1.0, blue: 1.0),
